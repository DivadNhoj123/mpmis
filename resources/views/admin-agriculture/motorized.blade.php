                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title fw-bold text-uppercase">Motorized Fishing Boats Records</h5>
                            <div class="ms-auto">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item waves-effect" href="{{route('motorized-print')}}">
                            ...
                            <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false"
                                ...
                                <div class="offcanvas-header">
                                    <h5 id="offcanvasScrollLabel" class="offcanvas-title">
                                        Register Motorized Boat
                                    </h5>
                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                        aria-label="Close"></button>
                                </div>
                                <form action="{{ route('agriculture-motorized.store') }}" method="POST"
                                            ...
                                            <div class="col mb-6 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="emailWithTitle" class="form-control"
                                                        name="name_of_boat" placeholder="Fill Boat name" required />
                                                    <label for="emailWithTitle">Name of Boat</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-6 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="emailWithTitle" class="form-control"
                                                        name="engine" placeholder="Fill engine/model" required />
                                                    <label for="emailWithTitle">Engine/Model</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-6 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="emailWithTitle" class="form-control"
                                                        name="engine_serial" placeholder="Fill engine serial number"
                                                        required />
                                                    <label for="emailWithTitle">Engine Serial Number</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-6 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="emailWithTitle" class="form-control"
                                                        name="hp" placeholder="Fill horsepower" required />
                                                    <label for="emailWithTitle">Horsepower</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-6 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="emailWithTitle" class="form-control"
                                                        name="color" placeholder="Fill color" required />
                                                    <label for="emailWithTitle">Color</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-6 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="emailWithTitle" class="form-control"
                                                        name="tonnage" placeholder="Fill tonnage" required />
                                                    <label for="emailWithTitle">Net Registered Tonnage</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    @foreach ($registers as $register)
                                        <tr>
                                            ...
                                            <td>{{ $register->name_of_boat }}</td>
                                            <td class="text-uppercase">{{ $register->engine }}</td>
                                            <td>
