        ...
        var initDemos = function() {
            $(".done").click(function(e) {
                ...
                swal({
                    ...
                    if (willUpdate) {
                        let route =
                            "{{ route('agriculture-motorized.update', '__id__') }}";
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                .val(),
                                name_of_boat: $('#name_of_boat' + registerId).val(),
                                engine: $('#engine' + registerId).val(),
                                engine_serial: $('#engine_serial' + registerId)
                                .val(),
                                hp: $('#hp' + registerId).val(),
                                color: $('#color' + registerId).val(),
                                tonnage: $('#tonnage' + registerId).val(),
            ...
            $(".renew").click(function(e) {
                ...
                swal({
                    ...
                    if (willRenew) {
                        let route = "{{ route('motorized-renew', '__id__') }}";
