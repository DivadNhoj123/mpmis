                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title fw-bold">APPOINTED OFFICIALS RECORDS</h5>
                            <div class="ms-auto">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    @include('admin-tupad.partials.modals.upload-appointed-excel')
                                    ...
                                    @foreach ($officials as $official)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @include('admin-tupad.partials.modals.appointed-modal.view-appointed')
                                                <a type="button" class="btn btn-icon btn-warning "
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#edit-modal{{ $official->id }}">
                                                    <i class="ri-edit-box-line"></i>
                                                </a>
                                                @include('admin-tupad.partials.modals.appointed-modal.edit-appointed')
